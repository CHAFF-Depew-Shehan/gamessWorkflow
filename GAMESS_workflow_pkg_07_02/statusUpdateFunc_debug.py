...
def evalNode(rxnPath,node):
    ...
    if searchType is 'fldr':
        ...
        print(rxnPath+searchFolder+searchTarget)
    ...
    if len(search) > 3:
        for cond in search[3:]:
            ...
            try:
                ...
                print('WARNING: Exception was found for conditions: ' + cond)
                nodeExists = False
    print('Search Target: ' + searchTarget + ' is ' + str(nodeExists))
